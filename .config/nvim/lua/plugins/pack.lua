vim.pack.add({
  ...
  { src = "https://github.com/L3MON4D3/LuaSnip", version = "v2.*", build = "make install_jsregexp" },
  ...
  { src = "https://github.com/nvim-neo-tree/neo-tree.nvim", version = "v3.*" },
  { src = "https://github.com/stevearc/oil.nvim" },
  { src = "https://github.com/kylechui/nvim-surround", version = "*" },
